...
const Cart = () => {
  ...
  const placeOrder = async () => {
    try {
      if (!selectedAddress) {
        return toast.error(t("pleaseSelectAddress"));
      }
    ...
    <div className="flex flex-col md:flex-row mt-16">
      <div className="flex-1 max-w-4xl">
        ...
        <div className="grid grid-cols-[2fr_1fr_1fr] text-gray-500 text-base font-medium pb-3">
          <p className="text-left">{t("productDetails")}</p>
      ...
      <div className="max-w-[360px] w-full bg-gray-100/40 p-5 max-md:mt-16 border border-gray-300/70">
        <h2 className="text-xl md:text-xl font-medium">{t("orderSummary")}</h2>
        ...
        <div className="mb-6">
          ...
          >
            ...
            <option value="Online">{t("onlinePaymentFuture")}</option>
          </select>
        </div>
        ...
        >
          {paymentOption === "COD" ? t("placeOrder") : t("proceedToCheckout")}
        </button>
      </div>
    </div>
  ) : null;
